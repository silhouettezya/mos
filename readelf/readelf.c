...
int readelf(u_char *binary, int size)
{
		...
		shdr = binary + ehdr->e_shoff;//section table addr
		sh_entry_count = ehdr->e_shnum;//section header table entry count
		sh_entry_size = ehdr->e_shentsize;//section header table entry size
